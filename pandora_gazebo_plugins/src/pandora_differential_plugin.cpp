...
namespace gazebo
{
  ...
  {
    this->reconfigure_srv_.reset(new dynamic_reconfigure::Server
  ...
  void GazeboRosDifferential::AddPhysicsForces(void)
  {
    ...
    */
    ...
    // left_front_wheel_link_->AddRelativeForce
    //     ( math::Vector3 ( 0, 0, force_multiplier * ( left_front_z - min_z ) ) );
    // left_rear_wheel_link_->AddRelativeForce
    //     ( math::Vector3 ( 0, 0, force_multiplier * ( left_rear_z - min_z ) ) );
    // right_front_wheel_link_->AddRelativeForce
    //     ( math::Vector3 ( 0, 0, force_multiplier * ( right_front_z - min_z ) ) );
    // right_rear_wheel_link_->AddRelativeForce
    //     ( math::Vector3 ( 0, 0, force_multiplier * ( right_rear_z - min_z ) ) );
