...
class GazeboRosDifferential : public ModelPlugin
{
  /// \brief Constructor
public:
  GazeboRosDifferential(void);

  /// \brief Destructor
public:
  virtual ~GazeboRosDifferential(void);
...
private:
  void LoadReconfigureThread(void);
...
private:
  void ConfigCallback(pandora_gazebo_plugins
...
private:
  double PIDAlgorithm(double error,
...
private:
  boost::shared_ptr
  <dynamic_reconfigure::Server<pandora_gazebo_plugins::DifferentialConfig> >
  reconfigure_srv_;

private:
  dynamic_reconfigure::Server
  <pandora_gazebo_plugins::DifferentialConfig>::CallbackType reconfigure_callback_;
