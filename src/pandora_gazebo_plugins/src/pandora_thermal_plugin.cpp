...
////////////////////////////////////////////////////////////////////////////////
// Constructor
PandoraThermalPlugin::PandoraThermalPlugin()
{
...
void PandoraThermalPlugin::configCallback(
...
////////////////////////////////////////////////////////////////////////////////
// Load the controller
void PandoraThermalPlugin::Load(sensors::SensorPtr _parent,
  sdf::ElementPtr _sdf,
  ...
  sdf::ElementPtr _sdf)
{
  ...
  this->deferred_load_thread_ = boost::thread(
    boost::bind(&PandoraThermalPlugin::LoadThread, this));
}

event::ConnectionPtr PandoraThermalPlugin::OnLoad(const boost::function<void()>& load_function)
{
...
////////////////////////////////////////////////////////////////////////////////
// Load the controller
void PandoraThermalPlugin::LoadThread()
{
  // Exit if no ROS
  ...
  if (!this->camera_name_.empty())
  {
    ...
    dynamic_reconfigure::Server<gazebo_plugins::GazeboRosCameraConfig>
      ::CallbackType f =
      boost::bind(&PandoraThermalPlugin::configCallback, this, _1, _2);
  ...
  this->image_pub_ = this->itnode_->advertise(
    ...
    boost::bind(&PandoraThermalPlugin::ImageConnect, this),
    boost::bind(&PandoraThermalPlugin::ImageDisconnect, this),
  ...
  ros::SubscribeOptions zoom_so =
    ros::SubscribeOptions::create<std_msgs::Float64>(
        "set_hfov", 1,
        boost::bind(&PandoraThermalPlugin::SetHFOV, this, _1),
        ros::VoidPtr(), &this->camera_queue_);
  ...
  ros::SubscribeOptions rate_so =
    ros::SubscribeOptions::create<std_msgs::Float64>(
        "set_update_rate", 1,
        boost::bind(&PandoraThermalPlugin::SetUpdateRate, this, _1),
        ros::VoidPtr(), &this->camera_queue_);
...
void PandoraThermalPlugin::SetHFOV(const std_msgs::Float64::ConstPtr& hfov)
{
...
////////////////////////////////////////////////////////////////////////////////
// Set Update Rate
void PandoraThermalPlugin::SetUpdateRate(
...
////////////////////////////////////////////////////////////////////////////////
// Increment count
void PandoraThermalPlugin::ImageConnect()
{
...
////////////////////////////////////////////////////////////////////////////////
// Decrement count
void PandoraThermalPlugin::ImageDisconnect()
{
  boost::mutex::scoped_lock lock(*this->image_connect_count_lock_);
...
void PandoraThermalPlugin::Init()
{
  ...
  this->callback_queue_thread_ = boost::thread(
    boost::bind(&PandoraThermalPlugin::CameraQueueThread, this));
...
void PandoraThermalPlugin::PutCameraData(const unsigned char *_src,
...
////////////////////////////////////////////////////////////////////////////////
// Put camera_ data to the interface
void PandoraThermalPlugin::PublishCameraInfo(common::Time &last_update_time)
{
  if (!this->initialized_ || this->height_ <=0 || this->width_ <=0)
    return;
...
void PandoraThermalPlugin::PublishCameraInfo()
{
  if (!this->initialized_ || this->height_ <=0 || this->width_ <=0)
    return;
